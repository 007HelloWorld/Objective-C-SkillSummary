...
-(NSArray *)dataArr{
    if (!_dataArr) {
        _dataArr = @[@"本地存储",@"原生与js交互",@"多线程",@"block",@"推送",@"定时器",@"Runtime",@"算法",@"动画",@"RAC",@"加解密",@"日期",@"崩溃问题",@"升级提示",@"xib的使用",@"三方登录",@"支付",@"遮盖",@"不规则Tabbar",@"进度条",@"时间操作",@"柱形图",@"字符串操作",@"扫码",@"筛选",@"复杂数据解析",@"激光推送",@"相机相册照片选取",@"获取设备旋转方向",@"一行按钮可更改宽度及状态",@"页面展示未条条框框"];
    }
    return _dataArr;
}
